        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap: snapshot.getChildren()){
                    ...
                    String sTotal = String.valueOf("Income: Rs. "+ totalAmount);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    for (DataSnapshot snap:snapshot.getChildren()){
                        ...
                        String sttotal=String.valueOf("Income: "+totalammount);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final Data model) {
                ...
                holder.setItemAmount("Amount: Rs. "+ model.getAmount());
                holder.setDate("On: "+model.getDate());
                holder.setItemName("Income Source: "+model.getItem());
